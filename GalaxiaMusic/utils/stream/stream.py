...
import config
from GalaxiaMusic import Carbon, YouTube, app
from GalaxiaMusic.core.call import Galaxia
from GalaxiaMusic.misc import db
from GalaxiaMusic.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from GalaxiaMusic.utils.exceptions import AssistantErr
from GalaxiaMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from GalaxiaMusic.utils.inline.playlist import close_markup
from GalaxiaMusic.utils.pastebin import Galaxiabin
from GalaxiaMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Galaxia.force_stop_stream(chat_id)
