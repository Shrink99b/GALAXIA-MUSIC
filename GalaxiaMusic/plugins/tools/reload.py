...
from GalaxiaMusic.utils.database import get_authuser_names, get_cmode
from GalaxiaMusic.utils.decorators import (ActualAdminCB, AdminActual,
                                         language)
from GalaxiaMusic.utils.formatters import alpha_to_int
...
async def restartbot(client, message: Message, _):
    ...
    try:
        db[message.chat.id] = []
        await Galaxia.stop_stream(message.chat.id)
    except:
        pass
