...
from GalaxiaMusic.misc import HAPP, SUDOERS, XCB
from GalaxiaMusic.utils.database import (get_active_chats,
                                       remove_active_chat,
